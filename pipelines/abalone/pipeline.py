"""Example workflow pipeline script for HDB Resale pipeline.
...
def get_pipeline(
    ...
    role=None,
    default_bucket=None,
    model_package_group_name="HDBResalePackageGroup",
    ...
    sklearn_processor = SKLearnProcessor(
        ...
        base_job_name=f"{base_job_prefix}/sklearn-hdbresale-preprocess",
    ...
    step_process = ProcessingStep(
        name="PreprocessHDBResaleData",
        step_args=step_args,
    )

    # training step for generating model artifacts (using xgboost as built-in algo https://docs.aws.amazon.com/sagemaker/latest/dg/xgboost.html)
    model_path = (
        f"s3://{sagemaker_session.default_bucket()}/{base_job_prefix}/HDBResaleTrain"
    )
    ...
    evaluation_report = PropertyFile(
        name="HDBResalePriceEvaluationReport",
        output_name="evaluation",
        path="evaluation.json",
    )
    step_eval = ProcessingStep(
        name="EvaluateHDBResaleModel",
        step_args=step_args,
